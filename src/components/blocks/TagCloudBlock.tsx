...
const tagColors = ['#ef4444', '#f97316', '#eab308', '#22c55e', '#3b82f6', '#a855f7', '#ec4899', '#14b8a6']
...
const tags = ['React', 'TypeScript', 'Node.js', 'CSS', 'Vite', 'Go', 'Docker', 'Redis']

export default function TagCloudBlock() {
	return (
		<TagCloudWrapper label="Tags Cloud">
			<IconCloud />
			{/* 				<TagList>
					{tags.map((tag) => (
						<Tag key={tag}>{tag}</Tag>
...
const TagCloudWrapper = styled(Surface)`
	width: 260px;
	display: flex;
